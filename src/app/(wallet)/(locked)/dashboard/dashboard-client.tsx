...
import SendTabPanel from "./_components/send-tab-panel";
import ReceiveTabPanel from "./_components/receive-tab-panel";
import TransactionsTabPanel from "./_components/transactions-tab-panel";
