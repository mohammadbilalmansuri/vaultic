    ...
    <AnimatePresence mode="wait">
      {opened && (
        <motion.div
          ...
          className="max-w-lg fixed bottom-8 right-8 z-50 backdrop-blur-xl p-5 rounded-2xl flex items-center justify-between gap-4 border-1_5 border-color shadow-xl"
        >
