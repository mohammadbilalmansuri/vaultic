      ...
      <AnimatePresence>
        {isVisible && (
          <motion.div
            ...
            className={cn(
              "absolute z-50 whitespace-nowrap rounded-lg p-2 text-sm pointer-events-none bg-zinc-300 dark:bg-zinc-950 heading-color leading-none font-medium dark:font-normal shadow-lg",
              {
