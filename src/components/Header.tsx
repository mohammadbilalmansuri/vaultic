      ...
      <div className="w-full max-w-screen-lg relative flex items-center justify-between py-4">
        <Link href="/" className="flex items-center gap-1">
          <svg
            ...
            viewBox="0 0 448 512"
            className="size-8 fill-teal-500"
          >
          ...
          <span className="text-3xl font-bold text-teal-500">Vaultic</span>
        </Link>
        ...
        <div className="flex items-center gap-2">
          <svg
            ...
            className={cn("size-5 fill-none", {
              "stroke-zinc-700": theme === "light",
              "stroke-zinc-500": theme !== "light",
            })}
          >
