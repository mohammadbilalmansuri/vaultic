...
const WalletRecovery: Icon = (props) => {
  return (
    <svg
      ...
      {...props}
    >
      <path d="M2.5 13.24V11.51C2.5 9.44001 4.18999 7.75 6.25999 7.75H17.74C19.81 7.75 21.5 9.44001 21.5 11.51V12.95H19.48C18.92 12.95 18.41 13.17 18.04 13.55C17.62 13.96 17.38 14.55 17.44 15.18C17.53 16.26 18.52 17.05 19.6 17.05H21.5V18.24C21.5 20.31 19.81 22 17.74 22H12.26" />
      ...
      <path
        ...
        strokeMiterlimit="10"
      />
      <path d="M4.22 15.28L3 16.5L4.22 17.72" strokeMiterlimit="10" />
      <path
